          ...
          <form action="#" method="POST" className="space-y-6">
            <div>
              ...
              <input
                ...
                id="name"
                required
                className="mt-1 px-4 py-2 bg-gray-800 border border-gray-700 text-gray-100 rounded w-full focus:outline-none focus:ring-2 focus:ring-green-600"
              />
            </div>
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-mono text-gray-400">
                Message
              </label>
              <textarea
                name="message"
